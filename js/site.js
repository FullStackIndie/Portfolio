...
function showTacoCat() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/Portfolio/img/sereja-ris-TacoCat-unsplash.webp");
...
function showFizzBuzz() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/Portfolio/img/sam-cernik-FizzBuzz-unsplash.webp");
    document.getElementById("challengeSummary").innerText =
...
function showSumOfAllFears() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/Portfolio/img/roman-synkevych-SumOfAllFears-unsplash.webp");
    document.getElementById("challengeSummary").innerText =
...
function showMortgageCalculator() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/Portfolio/img/mortgageCalcmid.webp");
    document.getElementById("challengeSummary").innerText =
...
function showSuperDogEvents() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/Portfolio/img/superdogevents.webp");
    document.getElementById("challengeSummary").innerText =
...
function showTodoList() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/Portfolio/img/todo-things.webp");
    document.getElementById("challengeSummary").innerText =
