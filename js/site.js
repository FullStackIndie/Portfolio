...
function showTacoCat() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/img/sereja-ris-TacoCat-unsplash.webp");
...
function showFizzBuzz() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/img/sam-cernik-FizzBuzz-unsplash.webp");
    document.getElementById("challengeSummary").innerText =
...
function showSumOfAllFears() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/img/roman-synkevych-SumOfAllFears-unsplash.webp");
    document.getElementById("challengeSummary").innerText =
...
function showMortgageCalculator() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/img/mortgageCalcmid.webp");
    document.getElementById("challengeSummary").innerText =
...
function showSuperDogEvents() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/img/superdogevents.webp");
    document.getElementById("challengeSummary").innerText =
...
function showTodoList() {
    ...
    document.getElementById("challengePicture").setAttribute("src", "https://dsm56ob6rdulz.cloudfront.net/img/todo-things.webp");
    document.getElementById("challengeSummary").innerText =
